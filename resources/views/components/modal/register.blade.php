        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <div class="relative p-6 flex-auto mx-10">
                ...
                <div>
                    ...
                    <input name="password_confirmation" class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs mb-3" id="password_confirmation" type="password" placeholder="Confirm your password" required>
