                        ...
                        <form action="{{ route('member.profile.update', Auth::user()->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="">
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Your name" value="{{ $user->name ?? '' }}" type="text" name="name" id="name" autocomplete="name" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            <label for="job" class="block mb-3 font-medium text-gray-700 text-md">Job</label>
                                            <input placeholder="Your job" value="{{ $user->detail_user->job ?? '' }}" type="text" name="job" id="job" autocomplete="job" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Your email" value="{{ $user->email ?? '' }}" type="email" name="email" id="email" autocomplete="email" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Your phone number" value="{{ $user->detail_user->contact_number ?? '' }}" type="number" name="contact_number" id="contact_number" autocomplete="contact_number" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <textarea placeholder="Your biography" type="text" name="biography" id="biography" autocomplete="biography" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" rows="4">{{ $user->detail_user->biography ?? '' }}</textarea>
                                        </div>
                                        <div class="col-span-6">
                                ...
                                <div class="px-4 py-3 text-right sm:px-6">
                                    ...
                                    <button type="submit" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-lg shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" onclick="return confirm ('Are you sure to submit this data?')">
                                        Save Changes
                                    </button>
                                </div>
                            </div>
