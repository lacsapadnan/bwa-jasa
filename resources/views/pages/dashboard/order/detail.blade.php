            ...
            <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
                <div class="col-span-8">
                    ...
                    <p class="text-sm text-gray-400">
                        {{ auth()->user()->order_freelancer()->count() }} Total Services
                    </p>
                </div>
                                        ...
                                        <div class="flex overflow-x-scroll hide-scroll-bar dragscroll">
                                            <div class="flex mt-2 flex-nowrap">
                                                 ...
                                                 @forelse ($thumbnail as $item)
                                                    <img class="inline-block w-24 mr-2 rounded-lg cursor-pointer" :class="{'border-4 border-serve-button': active == {{ $item->id }}}" src="{{ url(Storage::url($item->thumbnail)) }}" alt="thumbnail service" @click="changeThumbnail('{{ url(Storage::url($item->thumbnail)) }}', {{ $item->id }})">
                                                @empty
                                                    {{-- Empty --}}
                                                @endforelse
                                        ...
                                        <div>
                                            ...
                                            <div class="leading-8 text-md">
                                                ...
                                                <ul class="mb-4 list-check">
                                                    @forelse ($advantageService as $item)
